...
try: 
    ...
    if st.session_state['counter1_value'] == 0:
        ...
        @st.cache_data
        def load_data():
            df = pd.read_pickle('/Users/okankoklu/Desktop/TAB_HR/tab_hr_ise_girisler_clean_pkl.pkl').groupby(['sirket', 'ise_giris_tarihi'], as_index=False)['No'].count()
        ...
        #fig.update_xaxes( ticklabelpad=10)
